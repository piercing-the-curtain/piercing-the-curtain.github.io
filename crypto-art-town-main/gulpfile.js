...
gulp.task('watch', function (done) {
    ...
    gulp.watch('sass/*.scss', gulp.task('css-mqpacker')); //sassが更新されたらbs-reloadを実行
    // gulp.watch('sass/*.scss', gulp.task('bs-reload')); //sassが更新されたらbs-reloadを実行
    gulp.watch('./src/*.js', gulp.task('bs-reload')); //jsが更新されたらbs-relaodを実行
